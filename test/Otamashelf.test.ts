...
test('Otamashelf has commands', () => {
  ...
  expect(
    ...
    'otamashelf.pageUpdatersRegistry.get',
    'otamashelf.pageUpdatersRegistry.keys',
    'otamashelf.pageUpdatersRegistry.properties',
    'otamashelf.pageUpdatersRegistry.register',
